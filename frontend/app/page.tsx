...
export default function Home() {
    ...
    const runAttack = async () => {
        ...
        try {
            // Updated to point to EC2 Backend as per Deployment Guide
            // Replace <YOUR_EC2_IP> if this is not correct yet
            const response = await fetch("http://13.205.139.163:8000/attack", {
                method: "POST",
                body: formData,
            });
